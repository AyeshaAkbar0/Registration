  ...
  return (
    <div style={{ 
      ...
      <div style={{ position: 'relative', maxWidth: '90%', height: 'auto', marginTop: '20%' }}>
        ...
        <button onClick={handleClick} style={{ position: 'absolute', bottom: 0, left: '50%', transform: 'translateX(-50%)', backgroundColor: 'transparent', border: 'none', width: '200px', height: '50px', cursor: 'pointer' }}></button>
      </div>
    </div>
  );
}
